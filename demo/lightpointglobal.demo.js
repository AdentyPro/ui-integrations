window.addEventListener("VisitorPageView", () => {
  const popupTemplate = `<style>
    ...
    let isSegmentInit;
    let isHistoryInit;
    const siteName = "demo.lightpointglobal.com";
    ...
    const healthCareButton = document.querySelector('a[href="https://demo.lightpointglobal.com/verticals/healthcare"]');
    if(healthCareButton) {
        healthCareButton.addEventListener('click', healthCareButtonClickHandler);
    }
    const fintechButton = document.querySelector('a[href="https://demo.lightpointglobal.com/verticals/fintech"]');
    if(fintechButton) {
        fintechButton.addEventListener('click', fintechButtonClickHandler);
    }

    async function fintechButtonClickHandler(e) {
        e.preventDefault();
    ...
    // open popup on event
    window.addEventListener("identityCustomEvent", function(){
        openPopup("You viewed Identify and Track Anonymous Visitors earlier.");
    }, {once: true});
